...
3.    Находясь в папке с репозиторием можно запустить выполнение с помощью команды `python main.py` или использовать для запуска любые имеющиеся Python-IDE (IDLE, PyCharm и др.). 
